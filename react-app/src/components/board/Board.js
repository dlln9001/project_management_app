                        ...
                        <div className="flex items-center mb-2 group">
                            ...
                            <div className={`flex items-center gap-1 group ${isEditingGroupName && `w-full`} w-fit relative`}>
                                ...
                                {(isEditingGroupName && editingGroupId === groupId) && 
                                    <GroupColors groupId={groupId} userToken={userToken} renderComponent={renderComponent} setRenderComponent={setRenderComponent}
                                            renderGroups={renderGroups} setRenderGroups={setRenderGroups} currentGroup={currentGroup}/>
                                }
