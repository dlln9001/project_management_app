...
urlpatterns = [
    ...
    path('change-board-name/', views.change_board_name),
    path('change-board-description/', views.change_board_description),
    path('delete-board/', views.delete_board),
    ...
    path('edit-column-name/', views.edit_column_name)
]